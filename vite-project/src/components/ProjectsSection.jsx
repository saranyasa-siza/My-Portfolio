...
const projects = [
  ...
  },
  {
    ...
    description:
      "a mental health support application with team 'Deep_Learners' ",
  ...
  },
  {
    ...
    description:
      "An IoT-based helmet detection system to ensure vehicle ignition only when the helmet is worn, with a team.",
